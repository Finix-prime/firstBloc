...
class FormInput extends StatefulWidget {
  ...
  const FormInput({Key? key, required this.inputController, required this.text}) : super(key: key);
          ...
          child: BlocBuilder<LoginBloc, LoginState>(
            builder: (context, state) {
              return TextFormField(
                ...
                keyboardType: (widget.text == "Password" || widget.text == "Zipcode") ? TextInputType.number : TextInputType.emailAddress,
                ...
                decoration: InputDecoration(
                  suffixIcon: widget.text == "Password"
                      ? GestureDetector(
                          ...
                          child: obsecure ? const Icon(Icons.visibility) : const Icon(Icons.visibility_off),
                        )
                      : null,
                  label: widget.text == "Password" ? Text("${widget.text} 6 digit") : Text(widget.text),
